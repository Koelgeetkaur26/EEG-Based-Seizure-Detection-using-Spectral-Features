...
```bash
git clone https://github.com/<your-username>/eeg-seizure-detection
...
1. Shoeb, A., & Guttag, J. (2010). Application of machine learning to epileptic seizure detection. *ICML*.
...
3. Hjorth, B. (1970). EEG analysis based on its statistics. *Electroencephalography and Clinical Neurophysiology*, 29(3), 306–310.
4. Welch, P. D. (1967). The use of fast Fourier transform for estimation of power spectra. *IEEE Transactions on Audio and Electroacoustics*, 15(2), 70–73.
5. Chawla, N. V. et al. (2002). SMOTE: Synthetic minority over-sampling technique. *JAIR*, 16, 321–357.
6. Goldberger, A. et al. (2000). PhysioBank, PhysioToolkit, PhysioNet. *Circulation*, 101(23).
